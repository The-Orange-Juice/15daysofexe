...
int main()
{
    int i,j,k,upos=11,cpos=11,cmove,winner=0,uhealth=20,chealth=20,bullets=500,qtyofboomerang=20,qtyofwall=50,boost=0,nofboost=1;
...
void win(int winner) ///prints winning message
{
    ...
    case 1:
        ...
        printf("You win!\n");
        printf("Clue for today: A group of players forming one side in a competitive game or sport.\nA hot glowing body of ignited gas that is generated by something on fire.");
        Sleep(10000);
        break;
    case 2:
        SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE),wintextpos);
